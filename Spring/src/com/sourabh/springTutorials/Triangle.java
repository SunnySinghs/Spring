...
public class Triangle {
	...
	public Triangle(String type, Points pointA) {
		this.type = type;
		this.pointA = pointA;
	}
	...
	public void draw() {
		...
		System.out.println("Point B's x is "+getPointA().getX()+ " and y is "+getPointB().getY());
		System.out.println("Point A's x is "+getPointC().getX()+ " and y is "+getPointC().getY());
	}
}
